...
- [x] Day 4: Loop through slices using `for` and `range`
- [x] Day 5: Write a program to find the max and min in a slice
...
- [x] Day 5: Write a program to create and display a `Person` struct
...
- [x] Day 3: Handle errors returned by functions
- [x] Day 4: Understand `panic` and `recover` basics
- [x] Day 5: Write a function that validates input and returns an error if invalid
...
- [x] Day 5: Write a program that runs two tasks concurrently and waits for both
...
- [x] Day 3: Handle different URL paths
